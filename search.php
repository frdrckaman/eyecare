                                                        ...
                                                        <div class="panel-body">
                                                            <div class="table-responsive">
                                                                <table id="customers2" class="table datatable">
                                                                    ...
                                                                    <tbody>
                                                                    <?php if($_GET['id'] == 3){$getContent=$override->getSort3('payment','status',2,'nw_vn',1,'branch_id',$user->data()->branch_id,'id');}else{$getContent=$override->getSort4('payment','payment',0,'status',0,'nw_vn',1,'branch_id',$user->data()->branch_id,'id');}
