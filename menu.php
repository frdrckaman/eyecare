...
<ul class="x-navigation">
    ...
    <li class="xn-openable">
        ...
        <ul>
            ...
            <li><a href="addInfo.php?id=24"><span class="fa fa-plus-circle"></span>Add Recommendation</a></li>
            ...
            <li><a href="information.php?id=34"><span class="fa fa-list"></span>View Recommendation</a></li>
        </ul>
    </li>
    <li class="xn-openable">
