...
<!--                    <li><a href="form.php?id=8"><span class="fa fa-user"></span>Out Patient</a></li>-->
            ...
            <li class="xn-openable">
                <a href="#">Reports</a>
                <ul>
                    <li><a href="info.php?id=4"><span class="fa fa-clipboard"></span>Patient Info</a></li>
                    <li><a href="form.php?id=16" ><span class="fa fa-plus-square"></span>Turnover Report</a></li>
                    <li><a href="form.php?id=17" ><span class="fa fa-sort-amount-desc"></span>Clinic Report</a></li>
                </ul>
            </li>
        </ul>
