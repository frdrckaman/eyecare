...
$branch_id=null;$dis=0;$srch=null;$searchValue=null;$medC=0;
if($user->isLoggedIn()){
        ...
        if(Input::exists('post')){
            if($_GET['id'] == 0 || $_GET['id'] == 1){
                if(Input::get('calc')){$x=1;
                    ...
                    $lensCost = Input::get('lens_price');
                    $frameCost = Input::get('frame_price');
                    $totalMedCost = Input::get('checkupCost');
                    $totalMdc = Input::get('medCost');
                    $totalCost = $lensCost + $frameCost + $totalMedCost + $totalMdc;
                }
                elseif(Input::get('submitCash')){$x=1;
                    ...
                    if ($validate->passed() && $bitError == false && $checkError == false && $chckLens == false) {
                        try {
                            ...
                            $user->createRecord('lens_frame_sales',array(
                                    'lens_specs' =>Input::get('lens_spec'),
                                    'lens_price' =>Input::get('lens_price'),
                                    'frame_specs' =>Input::get('frame_spec'),
                                    'frame_price' =>Input::get('frame_price'),
                                    'pay_date' =>date('Y-m-d'),
                                    'payment_id' =>$checkupCost[0]['id'],
                                    'staff_id' => $user->data()->id,
                            ));
        ...
        <?php include 'menuBar.php'?>
            ...
            <div class="x-content-title">
                ...
                <div class="pull-left">
                    ...
                    <button class="btn btn-warning">The Management and All Staff of Family Eye Care Wish You Happy Birthday</button>
                    <?php }?>
                </div>
            ...
            <?php if($_GET['id'] == 0 && $user->data()->access_level == 3){?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input name="checkupCost" type="text" class="form-control" placeholder="" VALUE="<?=$cCost?>">
                ...
                <!--<div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-8">
                            <input name="lens_spec" value="<?=Input::get('lens_spec')?>" class="form-control" placeholder="Enter Lens Specifications">
                        </div>
                        <label class="col-md-1">&nbsp;</label>
                        <div class="col-md-2">
                            <input name="lens_price" value="<?=Input::get('lens_price')?>" class="form-control" placeholder="Price" >
                        </div>
                    </div>
                <hr>
                <h2>Frame</h2>
                <!--<div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-8">
                            <input name="frame_spec" class="form-control" value="<?=Input::get('frame_spec')?>" placeholder="Enter Frame Specifications">
                        </div>
                        <label class="col-md-1">&nbsp;</label>
                        <div class="col-md-2">
                            <input name="frame_price" value="<?=Input::get('frame_price')?>" class="form-control" placeholder="Price" >
                        </div>
                    </div>
                    <hr>
            ...
            elseif($_GET['id'] == 1 && $user->data()->access_level == 3){?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="insurance_no" class="form-control" value="<?=Input::get('insurance_no')?>" required="">
                    </div>
                    <label class="col-md-1"> </label>
                    <label class="col-md-1">Member No: </label>
                    <div class="col-md-4">
                        <input type="text" name="dependent_no" class="form-control" value="<?=Input::get('dependent_no')?>" required="">
                    </div>
                </div><hr>
                <h2>Prescribed Medicine</h2>
                <div class="form-group">
            ...
            <?php }
            elseif($_GET['id'] == 16){?>
                <h3>Daily Customer Turnover Report (DCTR)</h3>
                <h2>&nbsp;</h2>
                <form role="form" class="form-horizontal" method="post">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-1 control-label">Phone Number:&nbsp;&nbsp;</label>
                        <div class="col-md-5">
                            <input type="text" name="phone_number" class="form-control" placeholder="Enter surname">
                        </div>
                        <label class="col-md-1 control-label">Service:&nbsp;&nbsp;</label>
                        <div class="col-md-5">
                            <select name="service" id="p" class="form-control select" data-live-search="true">
                                <option value="">Select Service</option>
                                <option value="Consultation">Consultation</option>
                                <option value="Lenses">Lenses</option>
                                <option value="Frames">Frames</option>
                                <option value="Eye Drops">Eye Drops</option>
                                <option value="Specs Collection">Specs Collection</option>
            ...
            elseif($_GET['id'] == 17){?>
                <form method="post">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-1 col-md-10">
                            <label>Highest sale of the day</label>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <thead>
                                    <tr>
