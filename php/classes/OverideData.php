...
class OverideData{
   ...
   public function getNo($table){
    ...
    public function getSort4($table,$where,$id,$where1,$id1,$where2,$id2,$where3,$id3,$value){
        $query = $this->_pdo->query("SELECT * FROM $table WHERE $where = '$id'AND $where1 = '$id1' AND $where2 = '$id2' AND $where3 = '$id3'  ORDER BY $value DESC");
        $result = $query->fetchAll(PDO::FETCH_ASSOC);
        return $result;
    }
