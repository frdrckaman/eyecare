          ...
          if(Input::get('search_report')){
              ...
              if ($validate->passed()) {
                  try {
                      ...
                      if(Input::get('recommendation')){
                          foreach(Input::get('recommendation') as $recommend){
                              $user->createRecord('doctor_recommends',array(
...
<head>
    <!-- META SECTION -->
    <title> Family Eye Care | Doctor Panel</title>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-offset-1 col-md-10">
                                                    <select name="recommendation[]" multiple class="form-control select" data-live-search="true" title="Recommendation" >
                                                        <?php foreach($override->getData('recommendation') as $recommendation){?>
