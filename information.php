...
if($user->isLoggedIn()){
    if($user->data()->access_level == 1){
        ...
        elseif($_GET['id'] == 34){
            if(Input::exists('post')){
                if(Input::get('updateRecommendation')){
                    try{
                        $user->updateRecord('recommendation',array(
                            'name' => Input::get('name'),
                        ),Input::get('id'));
                        $successMessage = 'Recommendation Info Updated Successful';
                    }catch (PDOException $e){
                        die($e->getMessage());
                    }
                }
                elseif(Input::get('deleteRecommendation')){
                    try{
                        $user->deleteRecord('recommendation','id',Input::get('id'));
                        $successMessage = 'Recommendation Deleted Successful';
                    }catch (PDOException $e){
                        $e->getMessage();
                    }
                }
...
<head>
    <!-- META SECTION -->
    <title>Family Eye Care | Info </title>
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" name="price" class="form-control" value="<?=$frames['price']?>" />
                                                                        </div>
                                                                    </div>
                                                                    <label></label>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <input type="submit" name="updateFramePrice" value="Update Frame Price" class="btn btn-success" >
                                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table id="customers2" class="table datatable table-bordered">
                                            ...
                                            <tbody>
                                            <?php $x=0;foreach($override->getDataOrderBy('recommendation') as $ins){?>
                                                <tr>
                                                    <td><?=$ins['name']?></td>
                                                    <td>
                                                        <form method="post">
                                                ...
                                                <div class="modal" id="modal<?=$x?>" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                                                <h4 class="modal-title" id="defModalHead<?=$x?>">More Information about Recommendation</h4>
                                                            </div>
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <input type="hidden" name="id" value="<?=$ins['id']?>">
                                                                    <input type="submit" name="updateRecommendation" value="Update Recommendation" class="btn btn-success" >
                                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                ...
                                                <div class="modal" id="dlt<?=$x?>" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                                                <h4 class="modal-title" id="defModalHead<?=$x?>">DELETE RECOMMENDATION</h4>
                                                            </div>
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    <span style="color: #ff0000">
                                                                        <strong>ARE YOU SURE YOU WANT TO DELETE THIS RECOMMENDATION ?</strong>
                                                                    </span>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <input type="hidden" name="id" value="<?=$ins['id']?>">
                                                                    <input type="submit" name="deleteRecommendation" value="DELETE RECOMMENDATION" class="btn btn-danger" >
                                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                                </div>
                                                            </form>
                                                        </div>
