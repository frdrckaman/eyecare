            ...
            if (Input::exists('post')) {
                ...
                elseif($_GET['id'] == 24){
                    if(Input::get('recommendation')){
                        ...
                        if ($validate->passed()){
                            try{
                                $user->createRecord('recommendation', array(
                                    'name' => Input::get('name'),
                                ));
                                $successMessage = 'Recommendation Added successful';
                            }
                            catch(PDOException $e){$e->getMessage();}
                        }else {
                            $pageError = $validate->errors();
...
<head>
    <!-- META SECTION -->
    <title>Family Eye Care | Registration </title>
                ...
                <div class="panel-body padding-0">
                    <div class="panel-body">
                        <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post">
                            ...
                            <div class="pull-right">
                                <input type="submit"  name="recommendation" value="Add Recommendation" class="btn btn-success">
                            </div>
                        </form>
                    </div>
                </div>
